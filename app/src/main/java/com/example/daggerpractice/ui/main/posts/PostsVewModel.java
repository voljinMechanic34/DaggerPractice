...
public class PostsVewModel extends ViewModel {
    private static final String TAG = "PostsVewModel";
    private final MainApi mainApi;
    private final SessionManager sessionManager;

    private MediatorLiveData<Resource<List<Post>>> posts;
    @Inject
    public PostsVewModel(SessionManager sessionManager,MainApi mainApi) {
        this.sessionManager = sessionManager;
        this.mainApi = mainApi;
        Log.d(TAG, "PostsVewModel: viewmodel is working");
